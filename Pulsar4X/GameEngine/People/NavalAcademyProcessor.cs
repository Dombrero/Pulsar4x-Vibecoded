...
namespace Pulsar4X.People
{
    public class NavalAcademyProcessor : IInstanceProcessor
    {
        internal override void ProcessEntity(Entity entity, DateTime atDateTime)
        {
            ...
            {
                var commanderDB = CommanderFactory.CreateAcademyGraduate(entity.AttachedManager.Game);
                ...
                commanderDB.ExperienceCap = generator.NextBellCurve(entity.AttachedManager.Game.RNG, 0, 200, mean, 33.333);
                ...
                if (commanderDB.ExperienceCap > 30)
                {
                    ...
                    double sigma = mu / 6.0;
                    commanderDB.Experience = generator.NextBellCurve(entity.AttachedManager.Game.RNG, 0, Math.Min(commanderDB.ExperienceCap, 30), mu, sigma);
                }
                else
                {
            ...
            entity.AttachedManager.ManagerSubpulses.AddEntityInterupt(graduationDate, nameof(NavalAcademyProcessor), entity);
        }
    }
}