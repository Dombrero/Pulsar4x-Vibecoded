...
namespace Pulsar4X.Blueprints
{
    public class SystemGenSettingsBlueprint : Blueprint
    {
        ...
        /// </summary>
        public WeightedList<SpectralType> StarTypeDistributionForRealStars { get; set; } = new();
        /// <summary>
        /// Distribution of differnt star spectral types. These numbers are made up and can be tweaked for game balance.
        /// </summary>
        public WeightedList<SpectralType> StarTypeDistributionForFakeStars { get; set; } = new();
        /// <summary>
        ...
        /// </summary>
        public Dictionary<SpectralType, MinMaxStruct> StarRadiusBySpectralType { get; set; } = new();

        /// <summary>
        /// This Dictionary holds the minium and maximum Temperature (in degrees celsius) values for a Star given its spectral type.
        /// @note Do Not Modify these values as they are based on SCIENCE!!! See: http://en.wikipedia.org/wiki/Stellar_classification
        /// </summary>
        public Dictionary<SpectralType, MinMaxStruct> StarTemperatureBySpectralType { get; set; } = new();
        ...
        /// @note Do Not Modify these values as they are based on SCIENCE!!! See: http://en.wikipedia.org/wiki/Stellar_classification
        /// </summary>
        public Dictionary<SpectralType, MinMaxStruct> StarLuminosityBySpectralType { get; set; } = new();

        /// <summary>
        /// This Dictionary holds the minium and maximum mass values (in Kg) for a Star given its spectral type.
        /// @note Do Not Modify these values as they are based on SCIENCE!!! See: http://en.wikipedia.org/wiki/Stellar_classification
        /// </summary>
        public Dictionary<SpectralType, MinMaxStruct> StarMassBySpectralType { get; set; } = new();
        ...
        /// </summary>
        public Dictionary<SpectralType, MinMaxStruct> StarAgeBySpectralType { get; set; } = new();
        ...
        /// </summary>
        public Dictionary<SpectralType, double> StarSpectralTypePlanetGenerationRatio { get; set; } = new();
        ...
        /// </summary>
        public Dictionary<BodyType, MinMaxStruct> SystemBodyMassByType { get; set; } = new();

        /// <summary>
        /// Limits of a Planets density based on its type, in g/cm3
        /// @note That these values are based on bodies in our solar system and discovered Exoplanets. Some adjustment can be made for game play.
        /// </summary>
        public Dictionary<BodyType, MinMaxStruct> SystemBodyDensityByType { get; set; } = new();
        ...
        /// </summary>
        public Dictionary<SpectralType, MinMaxStruct> OrbitalDistanceByStarSpectralType_AU { get; set; } = new();
        ...
        /// @note These numbers, with the exception of G class stars, are based on habitable zone calculations. They could be tweaked for gameplay.
        /// </summary>
        public Dictionary<SpectralType, MinMaxStruct> OrbitalDistanceByStarSpectralType { get; set; } = new();

        /// <summary>
        /// Possible ranges for eccentricity by body type.
        /// </summary>
        public Dictionary<BodyType, MinMaxStruct> BodyEccentricityByType { get; set; } = new();
        ...
        /// </summary>
        public Dictionary<BodyType, MinMaxStruct> PlanetAlbedoByType { get; set; } = new();
        ...
        /// </summary>
        public Dictionary<BodyType, MinMaxStruct> PlanetMagneticFieldByType { get; set; } = new();
        ...
        /// </summary>
        public Dictionary<BodyType, double> AtmosphereGenerationModifier { get; set; } = new();
        ...
        /// </summary>
        public Dictionary<BodyType, double> MoonGenerationChanceByPlanetType { get; set; } = new();

        /// <summary>
        /// This is the maximium orbital distance of moons for each planet type.
        /// </summary>
        public Dictionary<BodyType, double> MaxMoonOrbitDistanceByPlanetType { get; set; } = new();
        ...
        /// </summary>
        public Dictionary<BodyType, double> MaxNoOfMoonsByPlanetType { get; set; } = new();
        ...
        /// </summary>
        public WeightedList<RuinsDB.RSize> RuinsSizeDistribution { get; set; } = new();
        /// <summary>
        ...
        /// @note These values can be tweaked as desired for game play.
        /// </summary>
        public WeightedList<RuinsDB.RQuality> RuinsQualityDistribution { get; set; } = new();
        /// <summary>
        /// The ranges for the Ruins Count, by Ruins Size.
        /// @note These values can be tweaked as desired for game play.
        /// </summary>
        public Dictionary<RuinsDB.RSize, MinMaxStruct> RuinsCountRangeBySize { get; set; } = new();

        /// <summary>
        /// The Quality modifiers. Final Ruins count is determined by RuinsCount * QualityModifier.
        /// @note These values can be tweaked as desired for game play.
        /// </summary>
        public Dictionary<RuinsDB.RQuality, double> RuinsQualityAdjustment { get; set; } = new();
        ...
        /// @note Should be a value between 0 and 1.
        /// </summary>
        public Dictionary<BodyType, double> MineralGenerationChanceByBodyType { get; set; } = new();

        /// <summary>
        /// Defines the maximum ammount of a mineral a given body type can support.
        /// @note These values can be tweaked as desired for game play.
        /// </summary>
        public Dictionary<BodyType, int> MaxMineralAmmountByBodyType { get; set; } = new();
    }
}
