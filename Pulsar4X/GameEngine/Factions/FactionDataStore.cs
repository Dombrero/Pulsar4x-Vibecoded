...
namespace Pulsar4X.Factions
{
    ...
    public class FactionDataStore
    {
        ...
        /// </summary>
        [JsonProperty]
        public SafeDictionary<string, ArmorBlueprint> LockedArmor { get; set; }
        [JsonProperty]
        public SafeDictionary<string, CargoTypeBlueprint> LockedCargoTypes { get; set; }
        [JsonProperty]
        public SafeDictionary<string, ComponentTemplateBlueprint> LockedComponentTemplates { get; set; }
        [JsonProperty]
        public SafeDictionary<string, IndustryTypeBlueprint> LockedIndustryTypes { get; set; }
        [JsonProperty]
        public SafeDictionary<string, Tech> LockedTechs { get; set; }
        [JsonProperty]
        public SafeDictionary<string, ArmorBlueprint> Armor { get; set; }
        [JsonProperty]
        public SafeDictionary<string, CargoTypeBlueprint> CargoTypes { get; set; }
        [JsonProperty]
        public SafeDictionary<string, ComponentTemplateBlueprint> ComponentTemplates { get; set; }
        [JsonProperty]
        public SafeDictionary<string, IndustryTypeBlueprint> IndustryTypes { get; set; }
        [JsonProperty]
        public SafeDictionary<string, Tech> Techs { get; set; }
        [JsonProperty]
        public CargoDefinitionsLibrary LockedCargoGoods { get; set; }
        [JsonProperty]
        public CargoDefinitionsLibrary CargoGoods { get; set; }
